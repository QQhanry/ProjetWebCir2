          ...
          <div class="container">  
            <div class="row">
              <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Recherche de voyages</h2>
              </div><br>
                <div class="form-group">
                  <input class="form-control"  onkeyup="filtre_recherche_titre()"   id="Titre_de_voyage" type="text" placeholder="Titre de voyage *" >
                  <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
                  <input class="form-control" id="CodePays" onkeyup="filtre_recherche_pays()" type="text" placeholder="CodePays *">
                  <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
                  <input class="form-control" id="Reference" onkeyup="filtre_recherche_reference()" type="text" placeholder="Référence *" >
                  <p class="help-block text-danger"></p>
                </div>
            </div>
          </div>
