...
ALTER TABLE reservation ADD CONSTRAINT FK_inscription_voyage FOREIGN KEY inscription(ref)
    REFERENCES voyage(ref) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reservation ADD CONSTRAINT FK_inscription_client FOREIGN KEY inscription(mail)
