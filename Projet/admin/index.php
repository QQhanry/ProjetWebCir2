  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">Bonjour Admin!</div>
        <div class="intro-heading text-uppercase center">Cherchez Vos voyages !</div>
            <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="Recherche.php">Rechercher</a>
      </div>
    </div>
